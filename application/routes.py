...
from flask import Blueprint, flash, session, request, render_template, redirect, url_for
...
@app_bp.route("/cup-champions.html")
def cup_champions():
...
@app_bp.route("/team/<team_id>.html")
...
@app_bp.route("/existing.html", methods=["POST", "GET"])
def existing_teams():
...
@app_bp.route("/build-team.html", methods=["GET", "POST"])
def build_team():
...
@app_bp.route("/add-players/<team_id>.html", methods=["GET", "POST"])
...
@app_bp.route("/choose-opponent.html")
def choose_opponent():
...
@app_bp.route("/opp-england.html", methods=["POST", "GET"])
def opp_england():
...
@app_bp.route("/opp-restofworld.html")
def opp_restofworld():
...
@app_bp.route("/login.html", methods=["GET", "POST"])
def login():
    """Renders Login page."""
...
@app_bp.route("/signup.html", methods=["GET", "POST"])
def signup():
    """Renders Signup page."""
